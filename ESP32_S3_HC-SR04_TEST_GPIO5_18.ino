/**
 * ESP32 S3 + HC-SR04 Ultrasonic Sensor Test Program - GPIO 5/18 WIRING
 * 
...
// Pin definitions for ESP32-S3 (GPIO 5/18)
...
void setup() {
  Serial.begin(115200);
  Serial.println("🧪 ESP32 S3 + HC-SR04 Connection Test - GPIO 5/18");
  Serial.println("===============================================");
