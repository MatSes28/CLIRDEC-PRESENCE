/**
 * ESP32 S3 + HC-SR04 Ultrasonic Sensor Test Program - OPTION 2 WIRING
 * 
...
// Pin definitions for ESP32-S3 (OPTION 2)
#define TRIG_PIN 5        // HC-SR04 Trigger pin (Alternative)
#define ECHO_PIN 6        // HC-SR04 Echo pin (Alternative)
#define LED_PIN 2         // Built-in LED

void setup() {
  Serial.begin(115200);
  Serial.println("🧪 ESP32 S3 + HC-SR04 Connection Test - OPTION 2");
  Serial.println("===============================================");
  Serial.println("📍 Using GPIO 5 (Trig) and GPIO 6 (Echo)");
...
void loop() {
  ...
  if (distance > 0) {
    ...
    Serial.println("🔍 Check connections (OPTION 2):");
    Serial.println("   - Trig pin: GPIO 5");
    Serial.println("   - Echo pin: GPIO 6");
