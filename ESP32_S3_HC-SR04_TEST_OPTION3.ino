/**
 * ESP32 S3 + HC-SR04 Ultrasonic Sensor Test Program - OPTION 3 WIRING
 * 
...
// Pin definitions for ESP32-S3 (OPTION 3)
#define TRIG_PIN 15       // HC-SR04 Trigger pin (Alternative)
#define ECHO_PIN 16       // HC-SR04 Echo pin (Alternative)
#define LED_PIN 2         // Built-in LED

void setup() {
  Serial.begin(115200);
  Serial.println("🧪 ESP32 S3 + HC-SR04 Connection Test - OPTION 3");
  Serial.println("===============================================");
  Serial.println("📍 Using GPIO 15 (Trig) and GPIO 16 (Echo)");
...
void loop() {
  ...
  if (distance > 0) {
    ...
    Serial.println("🔍 Check connections (OPTION 3):");
    Serial.println("   - Trig pin: GPIO 15");
    Serial.println("   - Echo pin: GPIO 16");
